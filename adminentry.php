  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav navbar-right">
        <li><a href="admin2.php"><span> GoBack</span></a></li>
        <li><a href="admin2.php"><span> TotalTransaction</span></a></li>	
...
<div id="example">
  ...
  <h3 align="center">this are the transactions from <?php echo "$Date2"; ?> to <?php echo "$Date3"; ?></h3>
<?php

    $total=0;

    $sql = "select * from  `transac` where date_time >= '".$Date2."' AND date_time <= '".$Date3."'";
...
$store="addedmoney";
 ...
 $total1=0;
    ...
    $sql = "select * from  `transac` where date_time >= '".$Date2."' AND date_time <= '".$Date3."' AND `store` = '".$store."'";
...
?>
		     ...
		     <h1 align="center">
      the total amount added into Amrita account is <?php echo "$total1";?>
     </h1>
      <h1 align="center">
      the total amount to be given by Amrita to merchants <?php echo "$total2";?>
     </h1>
